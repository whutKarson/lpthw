...
class CentralCorridor(Scene):
	...
	def enter(self):
		print(dedent("""
			The Gothons of Plannet percal #25 have invaded your ship and 
		...
		if action == "shoot!":
			print(dedent("""
				...
				bought him, which makes him fly into an insance range and blast you repeatedly
			...
			print(dedent("""
				...
				cranks a laser past your head. In the middle of your artful dodge your foot slips 
				and you bang your head on the metal wall and pass out.
				You wake up shortly after ony to die as the Gothon stomps on your head and eats you.
				"""))
			return 'death'
			...
			print(dedent("""
				...
				the busts out laughing and can't move.
	...
	def enter(self):
		...
		if guess == code:
			...
			print(dedent("""
				...
				as the mechanism is fused together. You decide to sit there,  and finally the
...
class TheBridge(Scene):
	...
	def enter(self):
		print(dedent("""
			...
			take control of the ship. Each of them has an event uglier
			clown costume than the last. They haven't pulled their weapons
			out yet, as they see the active bomb under your arm and don't want 
			to set it off.
			"""))
		...
		if action == "throw the bomb":
			print(dedent("""
				...
				you die you see another Gothon frantically try to disarm
			...
			print(dedent("""
				...
				at it. You then jump back through the door, punch the close button and blast
				the lock so the Gothons can't get out. Now that the bomb is placed your 
				run to the escape pod to get off this tin can.
				"""))
			return 'escpae_pod'
...
class EscapePod(Scene):
	...
	def enter(self):
		print(dedent("""
			...
			of interference. You get to the chamber with the 
		...
		if int(guess) != good_pod:
			...
			print(dedent("""
				You jump into pod {guess} and hit the eject button.
				The pod esasily slides out into space heading to 
